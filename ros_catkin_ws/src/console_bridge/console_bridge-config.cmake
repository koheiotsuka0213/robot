...
set(console_bridge_INCLUDE_DIRS /home/kohei/robot/ros_catkin_ws/devel_isolated/console_bridge/include)

foreach(lib console_bridge)
  set(onelib "${lib}-NOTFOUND")
  find_library(onelib ${lib}
    PATHS /home/kohei/robot/ros_catkin_ws/devel_isolated/console_bridge/lib
    NO_DEFAULT_PATH
    )
  if(NOT onelib)
